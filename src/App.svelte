...
<main>
  <Stack>
    ...
    <Text size="3">
      ...
      perhaps the most intriguing is Zen. Growing out of the wisdom of China,
      India, and Japan, Zen became a powerful movement to explore the
      lesser-known reaches of the human mind. Today Zen has come westward, where
      we are rediscovering modern significance in its ancient insights. This
      book is an attempt to encounter Zen in its purest form, by returning to
    ...
    <Text size="2">
      ...
      individual experience. And although our experience can be described and
